...
the text incorporated by LGPLv3; it does not relicense Octo Chat as GPL software.
...
places `Octo-Chat-Native-Sources.tar.gz` beside the matching installers at:
https://github.com/Shattermoon/octo-chat/releases
...
rebuilding and replacement on the supported Windows/Linux targets.
