...
- `Octo-Chat-Setup-x64.exe` — Intel/AMD Windows PCs
- `Octo-Chat-Setup-arm64.exe` — Windows on Arm
- `Octo-Chat-Extension.zip` — standalone companion extension
...
The detailed 2026-08-25 engineering log is in `docs/old docs-report/bughunt-2026-08-25.md`.
