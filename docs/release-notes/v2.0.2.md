Octo Chat 2.0.2 is the first release candidate from the native Windows/macOS/Linux
...
- `Octo-Chat-Setup-x64.exe` — Windows x64 (Intel/AMD)
- `Octo-Chat-Setup-arm64.exe` — Windows on Arm
- `Octo-Chat-macOS-x64.dmg` — macOS Intel disk image
- `Octo-Chat-macOS-x64.zip` — macOS Intel app archive
- `Octo-Chat-macOS-arm64.dmg` — macOS Apple silicon disk image
- `Octo-Chat-macOS-arm64.zip` — macOS Apple silicon app archive
- `Octo-Chat-Linux-x64.AppImage` — Linux x64 portable AppImage
- `Octo-Chat-Linux-x64.deb` — Linux x64 Debian/Ubuntu package
- `Octo-Chat-Linux-arm64.AppImage` — Linux ARM64 portable AppImage
- `Octo-Chat-Linux-arm64.deb` — Linux ARM64 Debian/Ubuntu package
...
- Linux desktop metadata now uses `com.octochat.app.desktop` consistently so the generated
