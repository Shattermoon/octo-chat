...
- `Octo-Chat-Setup-x64.exe` — Intel/AMD
- `Octo-Chat-Setup-arm64.exe` — Arm (Snapdragon, Surface Pro X)
- `Octo-Chat-Extension.zip` — the extension on its own, for loading unpacked
...
The full write-up is in `docs/old docs-report/bughunt-follow-up-2026-08-24.md`. Credible leads that were reviewed
