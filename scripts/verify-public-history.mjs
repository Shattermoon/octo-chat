...
const maintainerLogin = 'nkcbuilds';
const safeMaintainerEmail = /^(?:\d+\+)?nkcbuilds@users\.noreply\.github\.com$/i;
...
function publishedCommits() {
  ...
  const canonical = remotes.find((remote) => {
    ...
    return /^(?:https?:\/\/github\.com\/|ssh:\/\/git@github\.com\/|git@github\.com:)Shattermoon\/octo-chat(?:\.git)?\/?$/i.test(url);
  });
