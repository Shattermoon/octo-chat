...
const notices = [
  'Octo Chat — Third-party Notices',
  '',
  'Octo Chat remains MIT licensed; see LICENSE. This inventory preserves the license and notice texts',
  ...
  '',
  'Catalog artwork: Copyright (c) 2026 Octo Chat contributors. MIT licensed, see LICENSE.',
  ...
  'are not bundled with Octo Chat; their package directories retain their own licenses and notices.',
  ''
];
const missing = [];
notices.push('='.repeat(80), 'OpenAI Codex — adapted coding instructions and update_plan contract',
  ...
  'Octo Chat adapts identity and available tools, removes Codex-specific facilities and adds bounded plan details and session storage.', '');
...
notices.push('='.repeat(80), 'Optional plugin catalog — separate installations and hosted services', 'Reviewed package licenses and hosted-service references follow. External server code is not bundled with Octo Chat; custom installations and updates retain their own notices.', '');
