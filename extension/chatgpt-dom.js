...
var CLF_DOM = (() => {
   ...
   *
   * Octo Chat remains authoritative for its own call labels/results. This only supplies
   ...
   * recording "Octo Chat Desktop is now connected" as a ChatGPT failure.
   */
  ...
  async function pluginRefreshView(connectorName, expectedTools = [], expectedAppId = null) {
    const externalPlugins = connectorName === 'Octo Chat Plugins';
