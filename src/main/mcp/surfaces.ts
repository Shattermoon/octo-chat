 ...
 */
export const CONNECTOR_BRAND = 'Octo Chat';
...
const PLUGINS: SurfaceDefinition = {
  id: 'plugins', serverName: 'octo-chat-plugins',
  connectorName: `${CONNECTOR_BRAND} Plugins`,
  description: 'Tools from external MCP integrations installed and enabled in Octo Chat Settings, including Blender and other connected applications and services.',
