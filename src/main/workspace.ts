 ...
 * the same prefix: `/project/octo-chat/src/main/patch.ts` where `src/main/patch.ts`
 ...
 *
 * The workspace learned from `/project/octo-chat/src/main/patch.ts` should be the
...
export interface Workspace {
  /** Virtual path of the folder, e.g. `/project/octo-chat`. */
  virtual: string;
  real: string;
  at: number;
}
