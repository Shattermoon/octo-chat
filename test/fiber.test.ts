 ...
 */
const APP = 'Octo Chat Core';
const DESKTOP_APP = 'Octo Chat Desktop';
...
describe('the calls a turn says it made', () => {
  ...
  /**
   * A name is not a prefix game. `Octo Chat Backup` shares every character of the
  ...
  it('refuses a connector whose name merely starts with this app’s brand', async () => {
    const messages = [
      request('req-fake', 'read', { app: 'Octo Chat Backup' }),
      answer('res-fake', 'req-fake', 'read', 'Octo Chat Backup'),
